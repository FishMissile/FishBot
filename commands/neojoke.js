...
var jokes = [
    "What time did the man go to the dentist? Tooth hurtie",
  ...
  module.exports = {
    name: "neojoke",
    description: "Random Neokramer joke",
    usage:`${prefix}neojoke will play a random Neokramer joke.`,
    execute(message, args) {

      let joke = jokes[Math.floor(Math.random() * Math.floor(jokes.length))]
      message.channel.send("A wise man named Neokramer once said " + joke, {
          tts: true
        });
      // args[0]
